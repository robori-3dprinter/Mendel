...
[9, 16.4, 5,9, 3.4, 6.5, 11, 5.3, 8, 16, 11, 5.6, 10],//metric - M3 nut was 7; M3 was 4.4
...
round_corner_diameter = 5;		// Original = 8
...
//x_rod_centres=70;			// Prusa Mendel
x_rod_centres=rod_dist;		// Robori Mendel
y_rod_centres=183;
belt_width=6;
